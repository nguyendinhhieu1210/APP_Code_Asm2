...
public class ExpenseDatabaseHelper extends SQLiteOpenHelper {
    ...
    public Cursor getAllTransactions() {
        ...
        return db.rawQuery("SELECT * FROM " + TABLE_EXPENSES, null); // Don't forget to close the Cursor after usage
    }
    ...
    public Cursor getTransactionsByBudgetName(String budgetName) {
        SQLiteDatabase db = this.getReadableDatabase();
        return db.rawQuery("SELECT * FROM " + TABLE_EXPENSES + " WHERE " + COLUMN_BUDGET_NAME + " = ?", new String[]{budgetName});
    }
}
